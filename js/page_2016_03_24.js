	 ...
	 if(page.pageInfo!=""&&page.pageInfo.recordList!=null&&page.pageInfo.recordList.length>0&&page.pageInfo.pageCount>1){
        ...
        if (page.pageInfo.beginPageIndex<=page.pageInfo.endPageIndex){
            ...
            if(page.pageInfo.currentPage > 1){
               _html+='<a  href="javascript:pageinationView('+(page.pageInfo.currentPage - 1)+',\''+opera+'\')">';
               _html+='<span></span>上一页</a>';
            }
			 _html+="<ul>";
                ...
                _html+='<a class="zq_paging_toget" href="javascript:pageinationView('+(page.pageInfo.currentPage + 1)+',\''+opera+'\')">下一页<span></span></a>'
                ...
                _html+='<span class="zq_paging_numberis">页</span><input type="button" class="cls" id="zq_paging_numbget" value="确定">'
                _html+='</div>  </div>';
        } 
      return _html;
